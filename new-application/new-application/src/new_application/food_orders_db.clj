...
;(new-food-order {:do_date "9.1.2023." :month_name "Januar" :type_name "Pantelic zito"})
...
(defn list-type-names []
  (sql/query sql-db ["SELECT DISTINCT type_name FROM food_types WHERE type_name NOT LIKE 'Test food type'"]))
(list-type-names)
